...
const sheetVariants = cva(
  "fixed z-50 gap-4 border border-border/70 bg-surface-elevated p-6 text-surface-elevated-foreground shadow-overlay transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
