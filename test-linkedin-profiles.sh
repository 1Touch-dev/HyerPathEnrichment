#!/bin/bash
# Test script for verifying LinkedIn photo enrichment
# Usage: bash test-linkedin-profiles.sh
...
echo "==================================================="
echo "Testing LinkedIn Photo Enrichment"
echo "==================================================="
echo ""
...
for i in "${!PROFILES[@]}"; do
    ...
    echo "Submitting enrichment request..."
