...
Ran locally under WSL2 Ubuntu + Docker Engine (see [`setup_stack.sh`](2026-08-14-document-job-status-fix/setup_stack.sh)):
...
Script: [`run_e2e_tests.sh`](2026-08-14-document-job-status-fix/run_e2e_tests.sh) (registration through Proof 1/2). Full output: [`terminal-output.txt`](2026-08-14-document-job-status-fix/terminal-output.txt), Part 2/3.
...
Same script/run. Full output: [`terminal-output.txt`](2026-08-14-document-job-status-fix/terminal-output.txt), Part 2/3.
...
Final script/run: [`run_proof3.sh`](2026-08-14-document-job-status-fix/run_proof3.sh). Full output: [`terminal-output.txt`](2026-08-14-document-job-status-fix/terminal-output.txt), Part 3/3.
