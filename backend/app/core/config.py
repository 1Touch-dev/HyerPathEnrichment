...
class Settings(BaseSettings):
    ...
    # NOTE: remaining Module 2 §7 settings (perplexity_*, outreach_*) land with
    # the chunks that actually consume them (Phase B/C) — portfolio_public_base_url,
    # cv_chat_max_turns, and cv_feedback_model are added now because
    # portfolio/service.py, cv_chat_service.py, and feedback_generator.py already
    # read them and need them to be non-blocking per the reviewer gate.
