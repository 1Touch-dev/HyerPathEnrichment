...
Implementation lives in ``app.integrations.linkedin``; import from this module
...
from app.integrations.linkedin.client import LinkedInBrowserClient, scrape_photo
from app.integrations.linkedin.login import (
    connect_selenium,
    detect_page_state,
    find_login_input,
    find_sign_in_button,
