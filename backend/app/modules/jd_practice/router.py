...
from app.dependencies.rate_limit import enforce_jd_practice_rate_limit
...
@router.post(
    "/questions",
    response_model=JdPracticeResponse,
    dependencies=[Depends(enforce_jd_practice_rate_limit)],
)
