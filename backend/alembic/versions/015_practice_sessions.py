...
Revision ID: 015_practice_sessions
...
revision: str = "015_practice_sessions"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # Inline check constraints for SQLite compatibility
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        # Inline check constraint for SQLite compatibility
        sa.CheckConstraint(
