...
Revises: 025_merge_job_matching_and_stabilization_heads, 030_outreach_messages
...
down_revision: str | Sequence[str] | None = (
    "025_merge_job_matching_and_stabilization_heads",
...
def upgrade() -> None:
    ...
    stabilization head (025_merge_job_matching_and_stabilization_heads) back into
    a single head.
    """
